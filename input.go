...
// KeyboardGetXKBState Internal xkb_state exposed. Can be used for more
// advanced key handling. This is currently only exposed as a C struct.
func KeyboardGetXKBState() *C.struct_xkb_state {
	return C.wlc_keyboard_get_xkb_state()
}

// KeyboardGetXKBKeymap Internal xkb_keymap exposed. Can be used for more
// advanced key handling. This is currently only exposed as a C struct.
func KeyboardGetXKBKeymap() *C.struct_xkb_keymap {
	return C.wlc_keyboard_get_xkb_keymap()
}

// KeyboardGetCurrentKeys Get currently held keys
